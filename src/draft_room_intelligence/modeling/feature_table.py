            ...
            FeatureRow(
                {
                    ...
                    "adult_sample_tier": adjusted.adult_sample_tier if adjusted else ("exposure" if adult_games > 0 else "none"),
                    "adult_evidence_weight": f"{(adjusted.adult_evidence_weight if adjusted else 0.0):.6f}",
                    "meaningful_adult_sample": "1" if adjusted and adjusted.meaningful_adult_sample else "0",
                    ...
                    "meaningful_playoff_sample": "1" if adjusted and adjusted.meaningful_playoff_sample else "0",
