...
demo-2025-readiness: demo-2025-reproducible

demo-2025-local-readiness:
...
demo-2025-reproducible:
	PYTHONPATH=src $(PYTHON) -m draft_room_intelligence.cli build-demo-year 2025 --gap-top-n 35 --movement-top-n 40

demo-year:
	@test -n "$(DRAFT_YEAR)" || (echo "Set DRAFT_YEAR, for example: make demo-year DRAFT_YEAR=2025"; exit 2)
	PYTHONPATH=src $(PYTHON) -m draft_room_intelligence.cli build-demo-year $(DRAFT_YEAR)
...
historical-ushl-catalog:
	PYTHONPATH=src $(PYTHON) -m draft_room_intelligence.cli collect-ushl-catalog data/raw/cache/ushl_stats/seasons.json
